...
### **Math as Sentences Made of Actions**

In language, a basic sentence has a **subject** and a **predicate** (what the subject does).  

In mathematics, we have **quantities** that perform **actions** (operations) on each other to produce a **result**:

**[Quantity] [Action] [Quantity] = [Result]**

For example:  
5 + 3 = 8  
Here, 5 and 3 are quantities, "+" is the action (addition), and 8 is the result.

**Important Rule**: Zero cannot participate in an action because it is *not a quantity* — it is the absence of quantity. Zero can only appear as the *result* of an action (for example, 5 − 5 = 0).
...
This system emphasizes **meaning** and **well-formed structures**, just like good sentences in language. It starts from real quantities and clear actions, and it highlights where traditional mathematics adds convenient conventions (such as x^0 = 1 or 0! = 1) that may feel forced or meaningless when viewed strictly through "actions on quantities."

Division by zero is a perfect example of something that breaks the grammar — it simply does not make sense, just like certain incomplete or invalid sentences in language.
